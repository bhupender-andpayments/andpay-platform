...
// The courier master: there is NO separate /ops/couriers route; it is the
// vendor registry subset filtered CLIENT-SIDE to type === 'COURIER'. Rows of
// type MANUFACTURER or PRINT never appear here. Read-only.
