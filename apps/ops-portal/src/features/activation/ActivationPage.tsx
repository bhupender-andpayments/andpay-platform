...
//
// THE BATCHES CARD MOVED (Task 8/12). Per-batch CWD dispatch (download the
// activation sheet, mark a batch sent to the CWD) now lives on the batch
// page's NextStepCard; see apps/ops-portal/src/features/fulfillment/generate/
// NextStepCard.tsx for that documentation. This page is the cross-batch
// worklist only.
...
export function ActivationPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <InfoNote>Per-batch CWD dispatch lives on each batch page now. This list is the cross-batch worklist.</InfoNote>
