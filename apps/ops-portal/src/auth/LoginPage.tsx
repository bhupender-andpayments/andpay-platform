...
// YAGNI (task 7, check 1): login/logout/principal-display only. No
// self-service enrollment, no password reset, no route guard (task 9 adds
// routing/RequireAuth).
export function LoginPage() {
  ...
  async function onSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      // contract (auth-edge login.controller.ts) names it `handle`.
