...
// The modal counterpart to the reactive 403 step-up interceptor in
// ../api/client.ts. It renders only while the stepUpController singleton says a
// prompt is pending, so it sits once in the provider tree and serves any number
// of imperative promptStepUpTotp() calls. The demo skin restyles it; the
// controller contract (role=dialog, the TOTP field, Confirm/Cancel) is
// unchanged so the interceptor and its tests are untouched.
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <p className="mt-1 text-[13px] text-muted">
          This is a sensitive action. Enter your current authenticator code to continue.
        </p>
        <form
